...
- **Eval tab** — the sidecar file itself plus latest pass/fail. Run the live
  draft or current stable by hand. Agents without a sidecar show an empty
  state; Promote stays ungated.
